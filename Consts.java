...
public interface Consts {
   ...
   */
  public static final String PROJECT_ID = "ucla-swipes";

  /**
   * Set Project Number of your Google APIs Console Project.
   */
  public static final String PROJECT_NUMBER = "1075461562486";

  /**
   * Set your Web Client ID for authentication at backend.
   */
  public static final String WEB_CLIENT_ID = "1075461562486.apps.googleusercontent.com";
